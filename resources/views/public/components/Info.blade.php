<section class="bg-[#377B9A] h-[1000px] flex flex-col items-center text-white">
    <div class="w-[800px]  my-10 text-center">
    ...
    <div class='grid grid-cols-3 place-items-center w-[1080px] h-[600px]'>
        ...
        <div class="grid grid-rows-1 place-items-center w-[380px] gap-y-10 mt-[12px]">
            ...
            <div class="flex justify-center items-center gap-x-10 text-center infoan">
                ...
                <i class="delay-1 iconan fa-solid fa-thumbs-up text-white text-3xl bg-red-400 w-20 h-20 flex items-center justify-center rounded-full z-[20] flex-shrink-0"></i>
            </div>

            <div class="flex justify-center items-center gap-x-10 text-center z-[20] infoan">
                <div class="Info sw-[320px] flex flex-col">
                ...
                <i class="delay-2 iconan fa-solid fa-cloud text-white text-3xl bg-red-400 w-20 h-20 flex items-center justify-center rounded-full flex-shrink-0"></i>
            </div>
            ...
            <div class="flex justify-center items-center gap-x-10 text-center z-[20] infoan">
                ...
                <i class="delay-3 iconan fa-solid fa-display text-white text-3xl bg-red-400 w-20 h-20 flex items-center justify-center rounded-full flex-shrink-0"></i>
            </div>


        </div>

        <img src="{{asset('image/info.png')}}" alt="info" class="h-[610px] w-[300px]">

        <div class="grid grid-rows-1 place-items-center w-[380px] gap-y-8 mr-36 ">

            <div class="flex justify-center items-center gap-x-10 text-center z-[20] infoan">

                <i class="delay-3 iconan fas fa-sync-alt text-white text-3xl bg-red-400 w-20 h-20 flex items-center justify-center rounded-full flex-shrink-0"></i>
            ...
            <div class="Info w-[320px] flex justify-center items-center gap-x-10 text-center z-[20] infoan">

                <i class="delay-1 iconan fas fa-chart-bar text-white text-3xl bg-red-400 w-20 h-20 flex items-center justify-center rounded-full flex-shrink-0"></i>
            ...
            <div class="Info w-[320px] flex justify-center items-center gap-x-10 text-center z-[20] infoan">
                <i class="delay-2 iconan fas fa-cogs text-white text-3xl bg-red-400 w-20 h-20 flex items-center justify-center rounded-full flex-shrink-0"></i>
